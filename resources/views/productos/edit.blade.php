                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="form-floating mb-3 position-relative">
                            <input type="text" name="nombre" id="nombre" class="form-control ps-5 @error('nombre') is-invalid @enderror" placeholder="Nombre" value="{{ old('nombre', $producto->nombre) }}" minlength="3" maxlength="80" pattern="(?=.*[A-Za-zÁÉÍÓÚáéíóúÑñ])[A-Za-zÁÉÍÓÚáéíóúÑñ0-9\s\-\.,\(\)/\+%]{3,80}" title="Ingresa un nombre real de medicamento (ej. Amoxicilina 500 mg). No se permiten solo números." required>
                        ...
                        @enderror
                        <div class="form-floating mb-3 position-relative">
                            <textarea name="descripcion" id="descripcion" class="form-control ps-5 @error('descripcion') is-invalid @enderror" placeholder="Descripción" minlength="10" maxlength="500" style="height: 80px;">{{ old('descripcion', $producto->descripcion) }}</textarea>
