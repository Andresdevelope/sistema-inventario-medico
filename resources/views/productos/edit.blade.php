                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="form-floating mb-3 position-relative">
                            <input type="text" name="nombre" id="nombre" class="form-control ps-5 @error('nombre') is-invalid @enderror" placeholder="Nombre" value="{{ old('nombre', $producto->nombre) }}" required>
                        ...
                        @enderror
                        <div class="form-floating mb-3 position-relative">
                            <input type="text" name="codigo" id="codigo" class="form-control ps-5 @error('codigo') is-invalid @enderror" placeholder="Código" value="{{ old('codigo', $producto->codigo) }}" required>
                        ...
                        @enderror
                        <div class="form-floating mb-3 position-relative">
                            <textarea name="descripcion" id="descripcion" class="form-control ps-5 @error('descripcion') is-invalid @enderror" placeholder="Descripción" style="height: 80px;">{{ old('descripcion', $producto->descripcion) }}</textarea>
                        ...
                        @enderror
                        <div class="form-floating mb-3 position-relative">
                            <input type="text" name="presentacion" id="presentacion" class="form-control ps-5 @error('presentacion') is-invalid @enderror" placeholder="Presentación" value="{{ old('presentacion', $producto->presentacion) }}" required>
                        ...
                        @enderror
                        <div class="form-floating mb-3 position-relative">
                            <input type="text" name="unidad_medida" id="unidad_medida" class="form-control ps-5 @error('unidad_medida') is-invalid @enderror" placeholder="Unidad de Medida" value="{{ old('unidad_medida', $producto->unidad_medida) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        @enderror
                        <div class="form-floating mb-3 position-relative">
                            <input type="number" name="stock" id="stock" class="form-control ps-5 @error('stock') is-invalid @enderror" min="0" placeholder="Stock" value="{{ old('stock', $producto->stock) }}" required>
                        ...
                        @enderror
                        <div class="form-floating mb-3 position-relative">
                            <input type="number" name="stock_minimo" id="stock_minimo" class="form-control ps-5 @error('stock_minimo') is-invalid @enderror" min="0" placeholder="Stock mínimo recomendado" value="{{ old('stock_minimo', $producto->stock_minimo) }}">
